      ...
      <div className="px-8 py-8 max-w-6xl">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-semibold text-[oklch(0.33_0.09_155)] hover:underline"
              >
                View all
                <ArrowRight size={13} />
              </button>
            ...
            <div className="space-y-4">
              {discussions.map((disc, i) => (
                <div
                  key={i}
                  className="bg-card border border-border rounded-sm p-5 hover:border-[oklch(0.33_0.09_155)]/30 hover:shadow-sm transition-all duration-150 cursor-pointer group animate-fade-in-up"
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="text-sm font-semibold text-foreground leading-snug mb-2 group-hover:text-[oklch(0.33_0.09_155)] transition-colors">
                        {disc.title}
                      </h3>
            ...
            <div className="mt-6 p-5 bg-[oklch(0.33_0.09_155)]/5 border border-[oklch(0.33_0.09_155)]/20 rounded-sm">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[oklch(0.33_0.09_155)]/20 flex items-center justify-center">
                  <MessageSquare size={14} className="text-[oklch(0.33_0.09_155)]" />
                </div>
                ...
                <button
                  ...
                  className="bg-[oklch(0.33_0.09_155)] text-white px-4 py-2 text-xs font-semibold rounded-sm hover:bg-[oklch(0.28_0.09_155)] transition-colors"
                >
                  Post
                </button>
              </div>
          ...
          <div className="space-y-6">
                  ...
                  return (
                    <div key={i} className="flex items-center justify-between py-2 border-b border-border last:border-b-0">
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <Icon size={14} className="text-[oklch(0.33_0.09_155)]" />
                        {stat.label}
                      </div>
            ...
            <div className="bg-card border border-border rounded-sm p-5">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="text-xs text-[oklch(0.33_0.09_155)] hover:underline font-medium"
                >
                  View all
                </button>
              </div>
              <div className="space-y-4">
                {upcomingEvents.map((event, i) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 bg-[oklch(0.33_0.09_155)]/10 rounded-sm flex flex-col items-center justify-center shrink-0">
                        <span className="font-mono-custom text-[10px] text-[oklch(0.33_0.09_155)] font-bold leading-none">
                          {event.date.split(" ")[1].replace(",", "")}
                        </span>
                        <span className="font-mono-custom text-[9px] text-[oklch(0.33_0.09_155)]/70 uppercase">
                          {event.date.split(" ")[0]}
                        </span>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-semibold text-foreground leading-snug group-hover:text-[oklch(0.33_0.09_155)] transition-colors">
                          {event.title}
                        </p>
            ...
            {/* Join CTA */}
            <div className="bg-[oklch(0.18_0.04_155)] text-white rounded-sm p-5">
              ...
              <button
                ...
                className="w-full bg-[oklch(0.91_0.04_80)] text-[oklch(0.18_0.04_155)] py-2.5 text-sm font-bold rounded-sm hover:bg-[oklch(0.85_0.05_80)] transition-colors"
              >
